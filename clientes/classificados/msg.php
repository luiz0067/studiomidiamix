...
if($msg=="existe"){
  echo"<b>Usuário já existe!</b> <br><br><a href=index.php>Tente novamente, clique aqui</a>";
}
if($msg=="existe_cpf"){
  echo"<b>CPF já cadastrado, só é valido um cadastro por pessoa!</b> <br><br><a href=index.php>Voltar</a>";
}
