...
ini_set(“display_errors”, 0 );
						...
						$sql = "SELECT codigo,imagem,comentario FROM designgrafico"; //altere (designgrafico) para o nome de sua tabela.
						...
						$total="1";
						$sql = "SELECT codigo,imagem,comentario FROM designgrafico LIMIT $inicio, $lpp"; //altere (designgrafico) para o nome de sua tabela.
						...
						?>
							...
							<div class="item "  style="display:block; 	width:160px; height:109px; ">
								...
								<a href="./adm/imagens/<?php echo $row['imagem'];?>" rel="lightbox[roadtrip]" title="<?php echo $row['comentario']?>" >
								
								<img src="./adm/imagens/<?php echo $row['imagem'];?>" style="opacity: 0; position:absolute;" >
								</a>
								</div>	
						<?php
						}
						...
						{    
						echo "<a class='menurodape'>";    
						echo "<a class='menurodape' href=\"designpage.php?pg=".($pg - 1)."\" targe=\"_self\">Anterior</a> |"; // troque (pagina) pela link de sua página.    
						echo "</a>";
						}
						$i = 1;
						...
						{
						echo "<strong class='menurodape'><a class='menurodape'>";        
						echo " <a class='menurodape' href=\"designpage.php?pg=".$i."\" target=\"_self\">".$i."</a> "; // troque (pagina) pela link de sua página.        
						echo "</a></strong>";    
						}
						$i = $i + 1;
						}
						...
						{    
						echo "<a class='menurodape'>";    
						echo "| <a class='menurodape' href=\"designpage.php?pg=".($pg + 1)."\" targe=\"_self\">Próxima</a>\n"; // troque (pagina) pela link de sua página.    
						echo "</a>"; }      
