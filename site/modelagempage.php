...
ini_set(“display_errors”, 0 );
						...
						$sql = "SELECT codigo,imagem,comentario FROM modelagem"; //altere (modelagem) para o nome de sua tabela.
						...
						$total="1";
						$sql = "SELECT codigo,imagem,comentario FROM modelagem LIMIT $inicio, $lpp"; //altere (modelagem) para o nome de sua tabela.
						...
						{    
						echo "<a class='menurodape'>";    
						echo "<a class='menurodape' href=\"modelagempage.php?pg=".($pg - 1)."\" targe=\"_self\">Anterior</a> |"; // troque (pagina) pela link de sua página.    
						echo "</a>";
						}
						$i = 1;
						...
						{
						echo "<strong class='menurodape'><a class='menurodape'>";        
						echo " <a class='menurodape' href=\"modelagempage.php?pg=".$i."\" target=\"_self\">".$i."</a> "; // troque (pagina) pela link de sua página.        
						echo "</a></strong>";    
						}
						$i = $i + 1;
						}
						...
						{    
						echo "<a class='menurodape'>";    
						echo "| <a class='menurodape' href=\"modelagempage.php?pg=".($pg + 1)."\" targe=\"_self\">Próxima</a>\n"; // troque (pagina) pela link de sua página.    
						echo "</a>"; }      
