...
<link rel="stylesheet" href="css/lightbox.css" type="text/css" media="screen" />
	...
	$(window).load(function(){
		...
		$('.item img').each(function(){
			var el = $(this);
			el.css({"position":""}).wrap("<div class='img_wrapper' >").clone().addClass('img_grayscale').css({"position":"absolute","opacity":"0"}).insertBefore(el).queue(function(){
...
ini_set(“display_errors”, 0 );
						...
						$sql = "SELECT codigo,imagem,comentario FROM ilustracao"; //altere (ilustracaopage) para o nome de sua tabela.
						...
						$total="1";
						$sql = "SELECT codigo,imagem,comentario FROM ilustracao LIMIT $inicio, $lpp"; //altere (ilustracaopage) para o nome de sua tabela.
						...
						?>
								...
								<a style="height:500px; width:450px;" href="./imagem/<?php echo $row['imagem'];?>" rel="lightbox[roadtrip]" title="<?php echo $row['comentario']?>" >
								
								<img src="./imagem/<?php echo $row['imagem'];?>"  style="opacity: 0; position:absolute;" >
								</a>
								</div>			
						<?php
						}
						...
						{    
						echo "<a class='menurodape'>";    
						echo "<a class='menurodape' href=\"ilustracaopage.php?pg=".($pg - 1)."\" targe=\"_self\">Anterior</a> |"; // troque (pagina) pela link de sua página.    
						echo "</a>";
						}
						$i = 1;
						...
						{
						echo "<strong class='menurodape'><a class='menurodape'>";        
						echo " <a class='menurodape' href=\"ilustracaopage.php?pg=".$i."\" target=\"_self\">".$i."</a> "; // troque (pagina) pela link de sua página.        
						echo "</a></strong>";    
						}
						$i = $i + 1;
						}
						...
						{    
						echo "<a class='menurodape'>";    
						echo "| <a class='menurodape' href=\"ilustracaopage.php?pg=".($pg + 1)."\" targe=\"_self\">Próxima</a>\n"; // troque (pagina) pela link de sua página.    
						echo "</a>"; }      
