...
ini_set(“display_errors”, 0 );
						...
						$sql = "SELECT codigo,imagem,comentario FROM webdesign"; //altere (webdesign) para o nome de sua tabela.
						...
						$total="1";
						$sql = "SELECT codigo,imagem,comentario FROM webdesign LIMIT $inicio, $lpp"; //altere (webdesign) para o nome de sua tabela.
						...
						{    
						echo "<a class='menurodape'>";    
						echo "<a class='menurodape' href=\"webpage.php?pg=".($pg - 1)."\" targe=\"_self\">Anterior</a> |"; // troque (pagina) pela link de sua página.    
						echo "</a>";
						}
						$i = 1;
						...
						{
						echo "<strong class='menurodape'><a class='menurodape'>";        
						echo " <a class='menurodape' href=\"webpage.php?pg=".$i."\" target=\"_self\">".$i."</a> "; // troque (pagina) pela link de sua página.        
						echo "</a></strong>";    
						}
						$i = $i + 1;
						}
						...
						{    
						echo "<a class='menurodape'>";    
						echo "| <a class='menurodape' href=\"webpage.php?pg=".($pg + 1)."\" targe=\"_self\">Próxima</a>\n"; // troque (pagina) pela link de sua página.    
						echo "</a>"; }      
