	...
	<div id="tudo">
        ...
        <div class="linhas">
        	<div class="linhacentro" style="height:82px;">
              ...
              <div class="espaco" style="width:106px; height:82px;"><a href="./principal.php" target="_self" onmouseover="MM_swapImage('Image1','','./imagens/entrar2.gif',1)" onmouseout="MM_swapImgRestore()"><img src="./imagens/entrar1.gif" name="Image1" width="106" height="82" border="0" id="Image1" /></a></div>
