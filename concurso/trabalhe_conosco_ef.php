    ...
    <body>
		...
		<div style="float:left;">
            ...
            <div id='imprimir'>
              ...
              <form name="form1" id="form1" action="envia_trabalhe_conosco_pv.php" method="post" class="formcontato">				
						<div >
							<label for="nome">
								Nome completo
				...
				<div  style="margin:0">
					...
					<div style="margin-right:15px">
							<label for="interesse">
								...
								<span class="marcacaoObrigatorio">*</span>
								<br>
								<select name="interesse" id="interesse" style="width:138px;">
																											<option value="encino_medio">
										Administrativo									</option>
																																				<option value="fundamentalI">
										Docência								</option>
																																				<option value="fundamentalII">
										Serviços Gerais							</option>
																																				<option value="pre_vestibular">
										Departamento de TI							</option>
